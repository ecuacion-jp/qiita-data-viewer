...
public class AccAdminRecord extends AccAdminBaseRecord implements HtmlItemContainer {
  ...
  public AccAdminRecord() {
    super();
  }

  public AccAdminRecord(AccAdmin e, DatetimeFormatParameters params) {
    super(e, params);
  }
