...
public class QiitaItemRecord extends QiitaItemBaseRecord implements HtmlItemContainer {

  static final HtmlItem[] htmlItems =
      new HtmlItem[] {new HtmlItemString("title").stringMatchingCondition(PARTIAL, true),
          new HtmlItemSelect("isPrivate"), new HtmlItemSelect("isSlide")};

  public QiitaItemRecord() {
    super();
  }

  public QiitaItemRecord(QiitaItem e, DatetimeFormatParameters params) {
    super(e, params);
  }
