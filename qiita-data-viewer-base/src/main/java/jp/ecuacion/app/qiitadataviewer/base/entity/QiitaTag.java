...
import java.util.*;
import jp.ecuacion.app.qiitadataviewer.base.record.QiitaTagBaseRecord;
...
@Entity
@Table(name = "QIITA_TAG", uniqueConstraints = {@UniqueConstraint(columnNames = {"NAME"})})
@Filter(name = "groupFilter")
public final class QiitaTag extends SystemCommon implements Serializable {

  private static final long serialVersionUID = 1L;

  @Id
  @Column(name = "ID", nullable = false, columnDefinition = "bigserial")
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "QIITA_TAG_ID_SEQ_GEN")
  @SequenceGenerator(name = "QIITA_TAG_ID_SEQ_GEN", sequenceName = "QIITA_TAG_ID_SEQ", allocationSize = 1)
  protected Long id;
  ...
  public String[] getFieldNameArr() {
    return new String[] {"id", "accId", "name", "createAccId", "createTime", "lstUpdAccId", "lstUpdTime", "delFlg", "version"};
  }
  ...
  public QiitaTag(QiitaTagBaseRecord rec, Acc acc) {
    super(rec);
   ...
   */
  public QiitaTag(String name) {
    this();
    setName(name);
  }

  public void update(QiitaTagBaseRecord rec, Acc acc, String... skipUpdateFields) {
